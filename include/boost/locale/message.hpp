...
#ifndef BOOST_NO_CXX17_HDR_STRING_VIEW
            string_view(string_view_type s) : ptr_(s.data()), len_(s.size()) {}
            operator string_view_type() const { return string_view_type(ptr_, len_); }
#endif
